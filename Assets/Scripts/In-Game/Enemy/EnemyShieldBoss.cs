...
public class EnemyShieldBoss :EnemyShield {
    ...
    public override void TakeDamage(float damageAmount, Vector2 knockbackDirection, float knockbackDistance) {
        ...
        if(enemyHealth <= 0) {
            ...
            playerScript.IncreaseCoins(30);  // Recompensa más grande por matar al boss
        } else {
